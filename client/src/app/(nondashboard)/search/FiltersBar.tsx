...
const FiltersBar = () => {
    ...
    const updateURL = debounce((newFilters) => {
        ...
        Object.entries(cleanFilters).forEach(([key, value]) => {
                updateSearchParams.set(
                    key, 
                    Array.isArray(value) ? value.join(",") : value.toSring()
                );
        });
    ...
    // updates the filter based on the provided key value. 
    // Handling different filters types differently.
    const handleFilterChange = (
        ...
        if (key === "priceRange" || key === "squareFeet") {
          // These filters are stored as arrays of two numbers (e.g., [min, max]).
            ...
            // Applies to all other filter keys.
        } else {
            newValue = value === "any" ? "any" : value;
        }
        // Creates a new object newFilters by spreading the existing filters and updating the specified key with newValue.
